---
title: "Warblers Analysis"
description: |
  This is an analysis of Black-Throated Blue Warblers.
draft: true
author:
...
```{r}
warbler_data <- read_csv(here("_posts", "2021-02-24-warblers-analysis", "data", "bt_warblers.csv")) #Read in the warbler data using here()
